...
```bash
# X11开发库
libxtst-dev libxinerama-dev libxcursor-dev libxrandr-dev libxi-dev
...
- **代码行数**: ~1500行
- **模块数**: 7个主要模块
- **平台支持**: 4个平台（macOS, Windows, Linux X11, Linux Wayland）
